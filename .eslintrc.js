module.exports = {
    ...
    "rules": {
        ...
        "no-unused-vars": "off", // 사용 안 한 변수 중복 경고
        "spaced-commnet": "off", // 주석을 뒤에 쓰지 말라는 경고
        ...
        "react/react-in-jsx-scope": "off", // jsx를 사용하여도 React룰 꼭 improt 하지 않아도 된다
